    ...
    $.ajax( {
        ...
        success : function ( timeline ) {
            for ( var index in timeline ) {
                ...
                if ( item.type == "review" )
                    html = $( "<li><i class='fa fa-commenting-o bg-blue'></i><div class='timeline-item'><span class='time'><i class='fa fa-clock-o'></i> " + moment( new Date( item.archive_date ) ).format( 'HH:mm' ) + "</span> <h3 class='timeline-header'>Gave a review to " + item.tutor_name + "</h3> <div class='timeline-body'> <div class='row'><div class='col-md-12'><p>" + item.text + "</p> </div></div></div> </div> </div> </li>" );
