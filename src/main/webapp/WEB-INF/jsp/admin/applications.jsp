                                                    ...
                                                    <c:forEach var="application" items="${pendingApplications}">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <button class="btn btn-sm btn-primary screenshot" data-toggle="tooltip" title="Screenshot" data-url="<c:url value="/admin/applications/screenshot/${application.id}.png"/>">
