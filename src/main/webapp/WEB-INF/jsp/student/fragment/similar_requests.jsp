...
<c:if test="${not empty similar}">
    <table class="table table-striped">
        ...
        <c:forEach var="other" items="${similar}">
            <tr>
                <!-- upvotes -->
                <td class="col-md-1 col-sm-2 text-center"><span class="label label-default"><i
                ...
                <td class="col-md-1 col-sm-2 text-right">
                    <a href="<c:url value="/request/${other.request.id}"/>" class="btn btn-sm btn-info pull-right"><i
