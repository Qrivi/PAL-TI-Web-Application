...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="min-height: 1126px;">
        ...
        <section class="container container-box">
            <div class="row">
                <!-- My current bookings -->
                <div class="col-md-12 col-sm-12 box box-primary">
                                ...
                                <c:forEach var="booking" items="${myOpenBookings}">
                                    <div class="col-sm-4">
                                        <div class="info-box bg-blue-gradient">
                                            ...
                                            <a href="" alt="Tutor info"><!--TODO: show tutor profile page -->
                                                    <span class="info-box-icon">
                                                        <!-- TODO:: change default profile pic to tutor's picture -->
                                                        <img class="img-circle"
                                                             src="<c:url value="/resources/img/profile_pic.jpg"/>"
